...
public class ActivitiesController : ControllerBase
{
    ...
    {
        new Event { Name = "Legoland", ImageUrl = "/images/Billund.jpg", Description = "Experience Legoland in Billund", Country = "Denmark" },
        new Event { Name = "Tivoli", ImageUrl = "/images/Copenhagen.jpg", Description = "Experience Tivoli in Copenhagen", Country = "Denmark" },
        new Event { Name = "Kongelige teater", ImageUrl = "/images/Copenhagen1.jpg", Description = "Experience Kongelig teater in Copenhagen", Country = "Denmark" },
