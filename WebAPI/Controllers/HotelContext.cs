...
public class HotelContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Hotel>().HasData(
            new Hotel {Id = 1, Name = "Hotel Copenhagen", ImageUrl = "/images/CPH.jpg", Description = "A modern hotel in the heart of Copenhagen.", Country = "Denmark" },
            new Hotel {Id = 2, Name = "Hotel Aarhus", ImageUrl = "/images/Aarhus.jpg", Description = "A cozy hotel in Aarhus.", Country = "Denmark" },
            new Hotel {Id = 3, Name = "Hotel Berlin", ImageUrl = "/images/hotelb.jpg", Description = "An upscale hotel near Brandenburg Gate.", Country = "Germany" },
            new Hotel {Id = 4, Name = "Hotel Munich", ImageUrl = "/images/hotelmun.jpg", Description = "A charming hotel in Munich.", Country = "Germany" },
            new Hotel {Id = 5, Name = "Hotel Paris", ImageUrl = "/images/hotelp.jpg", Description = "A romantic hotel with views of the Eiffel Tower.", Country = "France" },
            new Hotel {Id = 6, Name = "Hotel Lyon", ImageUrl = "/images/hotellyon.jpg", Description = "A beautiful hotel in Lyon.", Country = "France" },
            new Hotel {Id = 7, Name = "Hotel Toronto", ImageUrl = "/images/hoteltoronto.jpg", Description = "A charming hotel in the city center.", Country = "Canada" },
            new Hotel {Id = 8, Name = "Hotel Vancouver", ImageUrl = "/images/hotelv.jpg", Description = "A stylish hotel in Milan.", Country = "Canada" },
            new Hotel {Id = 9, Name = "Hotel Sydney", ImageUrl = "/images/hotelss.jpg", Description = "A vibrant hotel near the beach.", Country = "Australia" },
            new Hotel {Id = 10, Name = "Hotel Canberra", ImageUrl = "/images/hotelc.jpg", Description = "A luxurious hotel in the capital.", Country = "Australia" },
            new Hotel {Id = 11, Name = "Hotel Tokyo", ImageUrl = "/images/hotelttt.jpg", Description = "A modern hotel in Manchester.", Country = "Japan" },
            new Hotel {Id = 12, Name = "Hotel Osaka", ImageUrl = "/images/hotelosa.jpg", Description = "A stylish hotel in the city.", Country = "Japan" },
            new Hotel {Id = 13, Name = "Hotel Brasilia", ImageUrl = "/images/hotelbra.jpg", Description = "A stylish hotel in the city.", Country = "Brazil" },
            new Hotel {Id = 14, Name = "Hotel Sao Paulo", ImageUrl = "/images/hotelpao.jpg", Description = "A stylish hotel in the city.", Country = "Brazil" },
            new Hotel {Id = 15, Name = "Hotel Beijing", ImageUrl = "/images/hotelbei.jpg", Description = "A stylish hotel in the city.", Country = "China" },
            new Hotel {Id = 16, Name = "Hotel Shanghai", ImageUrl = "/images/hotelshang.jpg", Description = "A stylish hotel in the city.", Country = "China" },
            new Hotel {Id = 17, Name = "Hotel Mumbai", ImageUrl = "/images/hotelmom.jpg", Description = "A stylish hotel in the city.", Country = "India" },
            new Hotel {Id = 18, Name = "Hotel Surat", ImageUrl = "/images/hotelcurry.jpg", Description = "A stylish hotel in the city.", Country = "India" },
            new Hotel {Id = 19, Name = "Hotel Moscow", ImageUrl = "/images/hotelputin.jpg", Description = "A stylish hotel in the city.", Country = "Russia" },
            new Hotel {Id = 20, Name = "Hotel Saint Petersburg", ImageUrl = "/images/hotelsaint.jpg", Description = "A stylish hotel in the city.", Country = "Russia" },
            new Hotel {Id = 21, Name = "Hotel Cape Town", ImageUrl = "/images/hoteltown.jpg", Description = "A stylish hotel in the city.", Country = "South Africa" },
            new Hotel {Id = 22, Name = "Hotel Johannesburg", ImageUrl = "/images/hotelburg.jpg", Description = "A stylish hotel in the city.", Country = "South Africa" },
            new Hotel {Id = 23, Name = "Hotel Cairo", ImageUrl = "/images/hotelsalah.jpg", Description = "A stylish hotel in the city.", Country = "Egypt" },
            new Hotel {Id = 24, Name = "Hotel Giza", ImageUrl = "/images/hotelgiza.jpg", Description = "A stylish hotel in the city.", Country = "Egypt" },
            new Hotel {Id = 25, Name = "Hotel Buenos Aires", ImageUrl = "/images/hotelaries.jpg", Description = "A stylish hotel in the city.", Country = "Argentina" },
            new Hotel {Id = 26, Name = "Hotel Cordoba", ImageUrl = "/images/hotelcor.jpg", Description = "A stylish hotel in the city.", Country = "Argentina" },
            new Hotel {Id = 27, Name = "Hotel Mexico City", ImageUrl = "/images/hotelmexico.jpg", Description = "A stylish hotel in the city.", Country = "Mexico" },
            new Hotel {Id = 28, Name = "Hotel Guadalajara", ImageUrl = "/images/hotelg.jpg", Description = "A stylish hotel in the city.", Country = "Mexico" },
            new Hotel {Id = 29, Name = "Hotel Istanbul", ImageUrl = "/images/hotelis.jpg", Description = "A stylish hotel in the city.", Country = "Turkey" },
            new Hotel {Id = 30, Name = "Hotel Antalya", ImageUrl = "/images/hotelan.jpg", Description = "A stylish hotel in the city.", Country = "Turkey" },
            new Hotel {Id = 31, Name = "Hotel Athens", ImageUrl = "/images/hotelat.jpg", Description = "A stylish hotel in the city.", Country = "Greece" },
            new Hotel {Id = 32, Name = "Hotel Rhodes", ImageUrl = "/images/hotelrho.jpg", Description = "A stylish hotel in the city.", Country = "Greece" }
        );
